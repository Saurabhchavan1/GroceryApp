...
const Hero = () => {
  ...
  <section>
    ...
    <div className='max-w-[1400px]min-h-screen mx-auto px-10  md:flex-row flex-col flex items-center md:pt-25 p-35'>
        <div className=' flex-1'>
            ...
            <p className='text-zinc-500 lg:text-lg text-md  max-w-[530px] mt-5 mb-10'>
